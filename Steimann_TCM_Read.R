...
for(i in 1:length(programs)){
  for(numbug in numbugs){
    ...
    for(j in 1:num_vers){
      ...
      output_cost_file1<- paste('D:/Steimann-FailRemove/output_metrics/','array',programs[i],'-',basename(tar_path),'_',numbug,'.csv', sep = '')
    ...
    output_cost_file1<- paste('D:/Steimann-FailRemove/output_considerRD/details/_',i,'_',programs[i],'_',numbug,'_average.csv', sep = '')   #store the details easy for debugging
